				...
				<div class="category-nav" id="cate-nav" >
					...
					<ul class="category-list" id="cate-list">
						<li class="dropdown side-dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="true">huy Clothing <i class="fa fa-angle-right"></i></a>
							<div class="custom-menu">
								<div class="row">
									<div class="col-md-4">
										<ul class="list-links">
											<li>
												<h3 class="list-links-title"><a href="#">Categories</a></h3></li>
