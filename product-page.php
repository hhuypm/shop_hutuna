...
<body>
	...
	<div class="section">
		...
		<div>
			<img src="./img/main-product01.jpg">
			<img src="./img/main-product02.jpg">
			<img src="./img/main-product03.jpg">
		</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="footer">
						<!-- footer logo -->
						<h3 class="footer-logo">Hệ thống của hàng<h3>
							<a class="logo" href="#">
		          </a>
						</div>
					<hr>
					<h4>Phan Minh Huy</h4>
					<h4>Bùi Phương Nam</h4>
					<h4>Vũ Xuân Tùng</h4>
				...
				<img src="./img/hutuna1.jpg" width="400px" height="200px" alt="" align=right>
				<!-- /footer widget -->
